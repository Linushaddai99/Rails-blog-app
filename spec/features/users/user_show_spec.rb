...
RSpec.describe 'user#show', type: :feature do
    ...
    before :each do
        ...
        @user_2 = User.create(name: 'Lilly Brian', photo: 'https://randomuser.me/api/portraits/women/1.jpg', bio: 'Teacher from Poland.')

        @post_one = Post.create(author: @user_1, title: 'My First trip to China', text: 'This is my first post')

        Comment.create(post: @post_one, author: @user_2, text: 'Nice!')
        Comment.create(post: @post_two, author: @user_2, text: 'Great!')
    ...
    it 'can see the number of posts the user has written' do
        expect(page).to have_content(@user_1.posts.count)
    end
    ...
    it "can see the user's first 3 posts" do
        most_resent_posts = @user_1.three_most_recent_posts
    ...
    it "When I click a user's post, it redirects me to that post's show page" do
        ...
        expect(page).to have_current_path user_post_path(@user_1.id, @post_one.id)
    end
