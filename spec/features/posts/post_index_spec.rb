...
RSpec.describe 'post#index', type: :feature do
    ...
    before :each do
        ...
        @post_one = Post.create(author: @user_1, title: 'Story', text: 'This is my first post')
        @post_two = Post.create(author: @user_1, title: 'Hello', text: 'This is my secound post')

        @comment_one = Comment.create(post: @post_one, author: @user_2, text: 'Nice!')
    ...
    it "can see how many likes a post has" do
        expect(page).to have_content(@user_1.likes.count)
    end
